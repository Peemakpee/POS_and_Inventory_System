                    ...
                    <div class="col-sm-12 mb-2">
                      <div class="input-group mb-2">
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control text-right" id="numberbox" onkeypress="return isNumberKey(event)" type="text" name="cash" placeholder="ENTER CASH" required>
                          <script>
                              $("#numberbox").on("change", function(){
                                var input = $(this).val();
                              if
                                (input < <?php echo $total; ?>)
                                {
