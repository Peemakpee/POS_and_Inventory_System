...
include'../includes/receipt_format.php';
  ...
  <div class="form-group row text-left mb-0">
    <div class="col-sm-9">
      <h5 class="font-weight-bold">
        ACAYLAR LUMBER TRADING OFFICIAL RECEIPT
      </h5>
    </div>
    ...
    <div class="col-sm-4 py-1">
      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td class="font-weight-bold text-right">₱ <?php echo number_format(intval($cash) - intval($grand));?></td>
        </tr>
      </table>
      <div class= "text-center">
        <button onclick= "window.print()" class= "btn btn-primary">Print Receipt</button>
        <button onclick= "window.location='pos.php';" class= "btn btn-success">Done</button>
    </div>
