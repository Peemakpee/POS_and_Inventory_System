          ...
          <form role="form" method="post" action="cust_transac.php?action=add">
            <div class="form-group">
              <input class="form-control"
                       id="a" placeholder="First Name" name="firstname" required>
                  <script> $("#a").bind('keyup blur',function(){ 
                    var node = $(this);
            ...
            <div class="form-group">
            <input class="form-control"
                       id="b" placeholder="Last Name" name="lastname" required>
                  <script> $("#b").bind('keyup blur',function(){ 
                    var node = $(this);
                    node.val(node.val().replace(/[^A-z ]/g,'') ); }
                    );
                  </script>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="cust_pos_trans.php?action=add">
            <div class="form-group">
            <input class="form-control"
                       id="c" placeholder="First Name" name="firstname" required>
                  <script> $("#c").bind('keyup blur',function(){ 
                    var node = $(this);
                    node.val(node.val().replace(/[^A-z ]/g,'') ); }
                    );
                  </script>
            ...
            <div class="form-group">
            <input class="form-control"
                       id="d" placeholder="Last Name" name="lastname" required>
                  <script> $("#d").bind('keyup blur',function(){ 
                    var node = $(this);
                    node.val(node.val().replace(/[^A-z ]/g,'') ); }
                    );
                  </script>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="emp_transac.php?action=add">          
              <div class="form-group">
              <input class="form-control"
                       id="e" placeholder="First Name" name="firstname" required>
                  <script> $("#e").bind('keyup blur',function(){ 
                    var node = $(this);
                    node.val(node.val().replace(/[^A-z ]/g,'') ); }
                    );
                  </script>
              ...
              <div class="form-group">
              <input class="form-control"
                       id="f" placeholder="Last Name" name="lastname" required>
                  <script> $("#f").bind('keyup blur',function(){ 
                    var node = $(this);
                    node.val(node.val().replace(/[^A-z ]/g,'') ); }
                    );
                  </script>
